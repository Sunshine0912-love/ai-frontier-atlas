...
- `/learn/`：四阶段、六研究域、46 节课的完整 syllabus 与连载进度
- `/learn/[slug]/`：含完整论述、公式推导、实现映射、决策表、实验和自检的研究长文
- `/method/`：来源分级、claim 边界、评分方法与维护流程

## Content contract

- 前沿信号：`fact`、`mechanism`、`impact`、`uncertainty`、`watchNext`、四维评分和直接来源。
- 系统课程：学习目标、先修、术语、问题设定、基线、公式、最小例子、张量/源码映射、工程决策、失败边界、实验、自检和至少三个可靠参考。
- 排版契约：任何可见文字不小于 12px；正文默认 16px，研究长文 17px/1.9 行高；中文长文使用高可读性无衬线字体。
